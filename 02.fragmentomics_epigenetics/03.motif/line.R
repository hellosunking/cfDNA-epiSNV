...
ggplot(data_long, aes(x = Position, y = Value, group = Sample)) +
  ...
  scale_x_continuous(breaks = c(1, 2), labels = c("Wt", "Nut"), limits = c(0.8, 2.2)) +
  theme(
  ...
  annotate("text", x = 1.5, y = max(data_long$Value), 
